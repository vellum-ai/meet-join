...
/** Plugin-provided HTTP route registration. */
...
/** Opaque handle returned from `registries.registerSkillRoute`. */
...
export interface RegistriesFacet {
  ...
  /** Register a shutdown hook. The host calls it during orderly shutdown. */
